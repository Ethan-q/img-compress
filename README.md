...
macOS 产物包含 Imgcompress.dmg 与 Imgcompress.pkg。
macOS 安装方式：dmg 打开后把 Imgcompress.app 拖到“应用程序”目录；或双击 pkg 进行安装。
macOS 采用 onedir 方式打包，启动更快但体积略大。
Windows 产物为 dist/Imgcompress.exe。
